...
SET targetargs="test -xml testresults.xml"
SET filter="+[*]* -[UnitTestsClivis*]* -[xunit.*]* -[*]Clivis.Startup* -[*]Clivis.Program* -[*]Clivis.Models.Nibe.NibeTemp* -[*]Clivis.Models.Nibe.NibeAuth* -[*]Clivis.Models.Netatmo.NetatmoAuth* -[*]Clivis.Models.AppKeyConfig*"  
SET coveragefile=Coverage.xml  
SET coveragedir=Coverage

REM Run code coverage analysis  
%opencover% -oldStyle  -register:user -target:%dotnet% -output:%coveragefile% -targetargs:%targetargs% -filter:%filter% -skipautoprops 
