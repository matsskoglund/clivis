...
docker tag mskvb0/clivis:latest 644569545355.dkr.ecr.eu-west-1.amazonaws.com/mskvb0/clivis:$BUILD_BUILDID
...
docker push 644569545355.dkr.ecr.eu-west-1.amazonaws.com/mskvb0/clivis:$BUILD_BUILDID
