...
terraform apply -var "aws_access_key=$1" -var "aws_secret_key=$2" -var "env_netatmo_password=$3" -var "env_netatmo_username=$4" -var "env_netatmo_clientsecret=$5" -var "env_netatmo_clientid=$6" -var "env_nibe_clientid=$7" -var "env_nibe_clientsecret=$8" -var "env_nibe_redirecturl=$9"  -var "image_id=$10"
